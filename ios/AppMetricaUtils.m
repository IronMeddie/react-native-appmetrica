...
+ (AMAAppMetricaConfiguration *)configurationForDictionary:(NSDictionary *)configDict
{
    ...
    if (configDict[@"crashReporting"] != nil) {
        crashesConfiguration.autoCrashTracking = [configDict[@"crashReporting"] boolValue];
...
+ (AMAECommerceCartItem *)ecommerceCartItemForDict:(NSDictionary *)ecommerceCartItemDict
{
    ...
    NSDecimalNumber *quantity = [NSDecimalNumber decimalNumberWithDecimal:[[ecommerceCartItemDict valueForKey:@"quantity"] decimalValue]];
...
+ (AMAECommerceAmount *)ecommerceAmountForDict:(NSDictionary *)ecommerceAmountDict
{
    ...
    NSDecimalNumber *value = [NSDecimalNumber decimalNumberWithDecimal:[[ecommerceAmountDict valueForKey:@"amount"] decimalValue]];
